$(function(){
	...
	var group = new Moon.View({
		...
		method:{
			refresh:function(){
				this.removeData(["title","name","path","normalSize","tiny","tinySize","large","largeSize","square","squareSize","alt","openValidator","converter"]);
				this.data.type = "text";
    ...
    var unit = new Moon.View({
        ...
        method:{
            refresh:function(){
                this.removeData(["title","name","path","normalSize","tiny","tinySize","large","largeSize","square","squareSize","alt","openValidator","converter","resize"]);
                this.data.type = "text";
                this.data.option = [{value:"",label:""}];
                this.data.path = "path";
                this.data.normal = "size";
	...
	var generator = new Moon.View({
		...
		method:{
			...
			refresh:function(){
				this.removeData(["title","name","path","normalSize","imagename","tiny","tinySize","large","largeSize","square","squareSize","alt","openValidator","openConverter","converter","alert","groupAlert","extension","fileName"]);
				this.data.type = "text";
				this.data.option = [{value:"",label:""}];
				this.data.validator = [{option:"",value:"",message:""}];
			...
			historyClear:function(){
				main.data.item = [];
				this.method.refresh.apply(this);
			},
			...
			clearGroup:function(){
				this.data.group = [];
				main.data.group = [];
				this.removeData(["groupTitle","groupName","openGroup"]);
